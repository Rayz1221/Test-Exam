...
<?php
	...
	// Run SQL query
	$sql = "SELECT * FROM MovieNames ORDER BY released_date";
...
<table class="table table-striped">
	<?php while($a_row = mysqli_fetch_assoc($results)):?>
		<tr>
          <td><a href="game-details.php?id=<?=$a_row['movie_id']?>"><?=$a_row['movie_name']?></a></td>
          <td><?=$a_row['price']?></td>
		  <td><a class="btn btn-outline-danger btn-sm" href="delete-game.php?id=<?=$a_row['movie_id']?>" role="button">Delete</a></td>
		<tr>
	<?php endwhile;?>
</table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="add-game.php" method="post">
          <div class="mb-3">
            <label for="GameName" class="col-form-label">Movie name:</label>
            <input type="text" class="form-control" id="GameName" name="GameName">
          </div>
          <div class="mb-3">
            <label for="GameDescription" class="col-form-label">Movie Genre</label>
		  ...
		  <div class="mb-3">
            <label for="GameRating" class="col-form-label">Movie Price:</label>
